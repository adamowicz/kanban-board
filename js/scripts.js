...
// tworzymy klasę dla kolumn naszej tablicy
function Column(name) {
    var self = this; //bo mamy funkcję 'createColumn' w funkcji 'Column' (która jest obiektem)
...
function initSortable() {
    ...
    }).disableSelection(); //żeby nie zaznaczał nam się tekst
};
